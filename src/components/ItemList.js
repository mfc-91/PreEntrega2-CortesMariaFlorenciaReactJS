	...
	<main>
		<div className="container-fluid bg-trasparent my-4 p-3" style={{ position: "relative" }}>
			<div
				...
				className="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 gx-5 "
			>
        ...
        <>
            <div className="col  mb-5">
                <div className="card custom-card h-100">
                    ...
                    <a className="a-link-normal pb-3 px-0 " target="_top" rel="noopener" title="to be defined" href={'/item?id=' + props.data.id }> 
                        <div className="mx-auto custom-img">
                            <img
